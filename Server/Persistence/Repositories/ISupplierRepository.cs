...
public interface ISupplierRepository
{
    ...
    Task<IReadOnlyList<SupplierDto>> GetDeletedAsync(CancellationToken ct = default);
    ...
    Task<Supplier?> FindIncludingDeletedAsync(int id, CancellationToken ct = default);

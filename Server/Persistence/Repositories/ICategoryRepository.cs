...
public interface ICategoryRepository
{
    ...
    Task<IReadOnlyList<CategoryDto>> GetDeletedAsync(CancellationToken ct = default);
    ...
    Task<Category?> FindIncludingDeletedAsync(int id, CancellationToken ct = default);

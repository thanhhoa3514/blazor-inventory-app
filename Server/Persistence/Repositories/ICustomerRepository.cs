...
public interface ICustomerRepository
{
    ...
    Task<IReadOnlyList<CustomerDto>> GetDeletedAsync(CancellationToken ct = default);
    ...
    Task<Customer?> FindIncludingDeletedAsync(int id, CancellationToken ct = default);
